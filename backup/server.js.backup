...
// Note: saveBookings is no longer needed as individual operations handle saving
function saveBookings(bookings) {
    // This function is deprecated - use individual database operations instead
    console.warn('saveBookings is deprecated. Use individual database operations.');
}
...
app.post('/api/confirm-booking', async (req, res) => {
    try {
        ...
        // Update all bookings with the same booking number (for grouped bookings)
        const groupBookings = bookings.filter(b => b.bookingNumber === bookingNumber);
        for (const groupBooking of groupBookings) {
            await db.updateBooking(groupBooking.id, updates);
        }
...
app.post('/api/book', async (req, res) => {
    ...
    try {
        ...
        for (const booking of allNewBookings) {
